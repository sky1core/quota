...
func isClaudeRuntimeEnv(key string) bool {
	switch key {
	case "CLAUDE_CODE_CLIENT_CERT", "CLAUDE_CODE_CLIENT_KEY", "CLAUDE_CODE_CLIENT_KEY_PASSPHRASE":
		return false
	}
	for _, prefix := range []string{"CLAUDE_", "ANTHROPIC_", "VERTEX_REGION_CLAUDE_",
		"ENABLE_CLAUDEAI_", "DISABLE_PROMPT_CACHING_", "ENABLE_PROMPT_CACHING_", "FORCE_PROMPT_CACHING_"} {
		if strings.HasPrefix(key, prefix) {
			return true
		}
	}
	switch key {
	case "CLAUDECODE", "API_FORCE_IDLE_TIMEOUT", "API_TIMEOUT_MS", "AWS_BEARER_TOKEN_BEDROCK",
		"BASH_DEFAULT_TIMEOUT_MS", "BASH_MAX_OUTPUT_LENGTH", "BASH_MAX_TIMEOUT_MS",
		"BETA_TRACING_ENDPOINT", "CCR_FORCE_BUNDLE",
		...
		"DISABLE_FEEDBACK_COMMAND", "DISABLE_BUG_COMMAND", "DISABLE_GROWTHBOOK",
		"DISABLE_INSTALLATION_CHECKS", "DISABLE_INSTALL_GITHUB_APP_COMMAND",
		"DISABLE_INTERLEAVED_THINKING", "DISABLE_LOGIN_COMMAND", "DISABLE_LOGOUT_COMMAND",
		"DISABLE_PROMPT_CACHING", "DISABLE_TELEMETRY", "DISABLE_UPDATES", "DISABLE_UPGRADE_COMMAND",
		"ENABLE_BETA_TRACING_DETAILED", "ENABLE_TOOL_SEARCH", "FALLBACK_FOR_ALL_PRIMARY_MODELS",
		"FORCE_AUTOUPDATE_PLUGINS", "IS_DEMO", "MAX_MCP_OUTPUT_TOKENS",
		"MAX_STRUCTURED_OUTPUT_RETRIES", "MAX_THINKING_TOKENS", "SLASH_COMMAND_TOOL_CHAR_BUDGET",
		"MCP_CLIENT_SECRET", "MCP_CONNECTION_NONBLOCKING", "MCP_CONNECT_TIMEOUT_MS",
		"MCP_DISCOVERY_CACHE", "MCP_DISCOVERY_CACHE_MAX_STALE_S", "MCP_DISCOVERY_CACHE_STRIKES", "MCP_DISCOVERY_CACHE_TTL_S",
		"MCP_OAUTH_CALLBACK_PORT", "MCP_PROTOCOL_NEGOTIATION", "MCP_REMOTE_SERVER_CONNECTION_BATCH_SIZE",
		"MCP_SDK_GENERATION", "MCP_SERVER_CONNECTION_BATCH_SIZE", "MCP_TIMEOUT", "MCP_TOOL_TIMEOUT",
		"TASK_MAX_OUTPUT_LENGTH", "USE_BUILTIN_RIPGREP",
		"OTEL_LOG_ASSISTANT_RESPONSES", "OTEL_LOG_RAW_API_BODIES", "OTEL_LOG_TOOL_CONTENT",
		"OTEL_LOG_TOOL_DETAILS", "OTEL_LOG_USER_PROMPTS", "OTEL_METRICS_INCLUDE_ACCOUNT_UUID",
		"OTEL_METRICS_INCLUDE_ENTRYPOINT", "OTEL_METRICS_INCLUDE_REPOSITORY",
		"OTEL_METRICS_INCLUDE_RESOURCE_ATTRIBUTES", "OTEL_METRICS_INCLUDE_SESSION_ID", "OTEL_METRICS_INCLUDE_VERSION":
		return true
	}
	return false
}
